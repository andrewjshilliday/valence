...
interface IconHeartDislikeProps extends React.HTMLAttributes<SVGElement> {}

const IconHeartDislike = ({ className }: IconHeartDislikeProps): JSX.Element => (
  <svg
...
export default IconHeartDislike;
