...
/******/ 	return __webpack_require__(__webpack_require__.s = "./functions/albums.ts");
/******/ })
/************************************************************************/
/******/ ({
...
const albums = async (event, _context) => {
...
const getAlbums = async (ids, storefront) => {
    const albums = [];
...
const getAlbum = async (id, storefront) => {
